...
export class NavbarComponent implements OnInit {
  ...
  getTitle() {
    ...
    else if (titlee.includes('table-list')) {
      return {
        pastPage: [{
          pastUrl: 'dashboard',
          pastLinkName: 'Dashboard',
        }],
        currentPageName: 'Table List'
      };
    }
    else if (titlee.includes('form-layout')) {
      return {
        pastPage: [{
          pastUrl: 'dashboard',
          pastLinkName: 'Dashboard',
        }],
        currentPageName: 'Form Layout'
      };
    }
    else if (titlee.includes('user-list')) {
      return {
        pastPage: [{
          pastUrl: 'dashboard',
          pastLinkName: 'Dashboard',
        }],
        currentPageName: 'User List'
      };
    }
    else if (titlee.includes('theme-setting')) {
      return {
        pastPage: [{
          pastUrl: 'dashboard',
          pastLinkName: 'Dashboard',
        }],
        currentPageName: 'Theme Setting'
      };
    }
